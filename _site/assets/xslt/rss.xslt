...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Standard Word Broadcasting Network</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Standard Word Broadcasting Network – Let Light Shine Out of Darkness">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Standard Word Broadcasting Network – Let Light Shine Out of Darkness">
			</a>
